  ...
  plop.setGenerator('VFA generate code - Get query list.', {
    ...
    prompts: [
      ...
      },
      {
        ...
        message: 'Do you need check authentication for this api (yes/no)? -> ',
        validate: function (value) {
          if (/.+/.test(value)) return true;
      ...
      },
      {
        ...
        message:
          'What are column names that you want to select from main table? - Optional. (Split by comma) (Ex. id,url,comment,etc...) -> ',
      },
      {
        type: 'input',
        name: 'selectAliasColumnName',
        message:
          'What is column names that you want to select from join tables? - Optional. (Split by comma) (Ex. userAlias.id,userAlias.userName,commentAlias.id,commentAlias.comment,etc...) -> ',
      },
      {
        type: 'input',
        name: 'outputParam',
  ...
  plop.setGenerator('VFA generate code - add.', {
    ...
    prompts: [
      ...
      },
      {
        ...
        message:
          'What is your other added values except for request parameter value for main table? - Optional (Ex. owner: owner,etc...) -> ',
      },
      {
        type: 'input',
        name: 'otherSaveInfo',
        message:
          'What is your save info for other tables? - Optional (Ex. skills:array:id;skillsRepository;projectsSkillsRepository;ProjectsSkillsEntity;project:skill,etc...) -> ',
      },
      {
        type: 'input',
        name: 'isSkipOverrideModule',
  ...
  plop.setGenerator('VFA generate code - update.', {
    ...
    prompts: [
      ...
      },
      {
        ...
        message:
          'What is your delete info for other tables? - Optional (Ex. projectsSkillsRepository->{project:{id: id}},etc...) -> ',
      },
      {
        type: 'input',
        name: 'otherSaveInfo',
  ...
  plop.setGenerator('VFA generate E2E code - get query list.', {
    ...
    prompts: [
      ...
      },
      {
        ...
        name: 'graphqlInfo',
        message:
          'What is your graphql info? (Ex. id,url,comment,owner-id;userName;email;gender,comments-id;comment,etc...) -> ',
        validate: function (value) {
          if (/.+/.test(value)) return true;
          return 'graphqlInfo is required.';
        },
      },
      {
        type: 'input',
        name: 'importEntity',
        message:
          'What is your imported entity for preparing data? (Ex. PhotosEntity;../../../src/entities/photos.entity,CommentsEntity;../../../src/entities/comments.entity,etc...)?  -> ',
        validate: function (value) {
          if (/.+/.test(value)) return true;
          return 'importEntity is required.';
        },
      },
      {
        type: 'input',
        name: 'saveInfo',
        message:
          'What is your save info for main table? (Ex. PhotosEntity->[{"id":1,"url":"test_url_1","comment":"test_comment_1","owner":{"id":1,"userName":"unit_test","email":"unit_test@gmail.com","gender":"male"}},{"id":2,"url":"test_url_2","comment":"test_comment_2","owner":{"id":1,"userName":"unit_test","email":"unit_test@gmail.com","gender":"male"}}], etc...) -> ',
        validate: function (value) {
          if (/.+/.test(value)) return true;
      ...
      },
      {
        ...
        message:
          'What is your save info for other tables? - Optional (Ex. comments:array->CommentsEntity->[{"id":1,"comment":"c_1","owner":{"id":1},"photo":{"id":1}},{"id":2,"comment":"c_2","owner":{"id":1},"photo":{"id":2}}], etc...) -> ',
      },
    ],
    actions: [
      async function customAction(answers) {
  ...
  plop.setGenerator('VFA generate E2E code - get query one.', {
    ...
    prompts: [
      ...
      },
      {
        ...
        name: 'saveInfo',
        message:
          'What is your save info for main table? (Ex. PhotosEntity->[{"id":1,"url":"test_url","comment":"test_comment","owner":{"id":1,"userName":"unit_test","email":"unit_test@gmail.com","gender":"male"}}]) -> ',
        validate: function (value) {
          if (/.+/.test(value)) return true;
          return 'saveInfo is required.';
        },
  ...
  plop.setGenerator('VFA generate E2E code - add.', {
    ...
    prompts: [
      ...
      },
      {
        ...
        message:
          'What is your validation parameters for string? - Optional (Ex. comment;{"comment":1}<->url;{"url":1}, etc...) -> ',
      },
      {
        type: 'input',
  ...
  plop.setGenerator('VFA generate E2E code - update.', {
    ...
    prompts: [
      ...
      },
      {
        ...
        name: 'graphqlInfo',
        message:
          'What is your graphql info? (Ex. UpdatePhotoDto->{"url":"update_test_url","comment":"update_test_comment"}->id,url,comment,owner-id;userName;email;gender,etc...) -> ',
        validate: function (value) {
          if (/.+/.test(value)) return true;
          return 'graphqlInfo is required.';
        },
  ...
  plop.setGenerator('VFA generate E2E code - delete.', {
    ...
    prompts: [
      ...
      },
      {
        ...
        name: 'findInfo',
        message:
          'What is your search info for checking this data that is deleted from table? (Ex. PhotosEntity->[{"id":1}],etc... -> ',
        validate: function (value) {
          if (/.+/.test(value)) return true;
