...
export abstract class IMutation {
    ...
    abstract deletePhoto(id: number): Nullable<DeleteResponse> | Promise<Nullable<DeleteResponse>>;

    abstract deleteProject(id: number): Nullable<DeleteResponse> | Promise<Nullable<DeleteResponse>>;
